...
const corsOptions = {
  origin: ['http://localhost:3000', 'https://movies.daiana.nomoredomainswork.ru', 'http://movies.daiana.nomoredomainswork.ru'], // Добавьте здесь все домены, с которых ожидаются запросы
